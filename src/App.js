...
function transformData(data) {
  return data.c.map((item, index) => ({
    ...
    volume: Number(data.o[index]).toFixed(2),
    high: Number(data.o[index]).toFixed(2),
    low: Number(data.o[index]).toFixed(2),
    ...
    <div>
      ...
      <div className="container">
        <LineChart width={900} height={500} data={data}
          ...
          <Line type="monotone" dataKey="volume" stroke="green" dot={false} />
          <Line type="monotone" dataKey="high" stroke="red" dot={false} />
          <Line type="monotone" dataKey="low" stroke="black" dot={false} />
        </LineChart>
      </div>
      <div className="container">
